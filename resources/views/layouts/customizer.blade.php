<style>
    {{-- Cetak: sembunyikan tombol tema / back-to-top / preloader (Bootstrap .d-md-block memakai !important dan memuat setelah @section('css') di banyak halaman). --}}
    @media print {
        .customizer-setting.d-none.d-md-block,
        .customizer-setting .btn-icon[data-bs-target="#theme-settings-offcanvas"],
        #back-to-top,
        #preloader,
