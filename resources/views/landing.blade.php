        ...
        <div class="layout-wrapper landing">
            ...
            <section class="section bg-light" id="plans">
                ...
                <div class="container">
                    ...
                    <div class="row gy-4">
                        @forelse ($landingPricingPlans as $plan)
                            <div class="col-lg-4">
                                <div class="card plan-box mb-0 {{ $plan->is_popular ? 'ribbon-box right' : '' }}">
                                    @if ($plan->is_popular)
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="avatar-sm">
                                                <div class="avatar-title bg-light rounded-circle text-primary">
                                                    <i class="{{ $plan->icon_class }} fs-20"></i>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <ul class="list-unstyled text-muted vstack gap-3">
                                                ...
                                                @foreach ($plan->features as $feature)
                                                    <li>
                                                        <div class="d-flex">
                                                            <div
                                                                class="flex-shrink-0 {{ $feature->is_included ? 'text-success' : 'text-danger' }} me-1">
                                                                <i
                                                                    class="{{ $feature->is_included ? 'ri-checkbox-circle-fill' : 'ri-close-circle-fill' }} fs-15 align-middle"></i>
                                                            </div>
                                                            <div class="flex-grow-1">
                                                                {!! strip_tags($feature->display_text, '<b><strong>') !!}
                                                            </div>
                                                        </div>
                                                    </li>
                                                @endforeach
