    ...
    <div class="row">
        <div class="col-xl-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('operations-resources.store') }}" id="resourceCreateForm">
                        @csrf
                        @if ($showTenantSwitcher)
        ...
        <div class="col-xl-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('operations-resources.index') }}" class="row g-2 mb-3"
                    ...
                    <div id="resourceListContainer">
                        @include('partials.operations-resource-list')
                    </div>
                </div>
            </div>
        </div>
