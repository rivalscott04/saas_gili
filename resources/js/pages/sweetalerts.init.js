...
if (document.getElementById("sa-system-alert")) {
    var systemAlertElement = document.getElementById("sa-system-alert");
    var reason = systemAlertElement.getAttribute("data-sa-reason") || "ACCESS_DENIED";
    var title = systemAlertElement.getAttribute("data-sa-title") || "Notice";
    var text = systemAlertElement.getAttribute("data-sa-text") || "";
    var icon = systemAlertElement.getAttribute("data-sa-icon") || "warning";
    var config = {
        title: title,
        text: text,
        icon: icon,
    ...
    } else if (reason === "SUBSCRIPTION_EXPIRED" || reason === "USER_SUSPENDED") {
        config = {
            html: '<div class="mt-3">' +
                '<lord-icon src="https://cdn.lordicon.com/tdrtiskw.json" trigger="loop" colors="primary:#f06548,secondary:#f7b84b" style="width:120px;height:120px"></lord-icon>' +
                '<div class="mt-4 pt-2 fs-15 mx-4">' +
