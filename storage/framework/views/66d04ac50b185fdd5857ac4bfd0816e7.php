<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.item-details'); ?>
                                        ...
                                        <table class="table align-middle table-nowrap mb-0">
                                            <tbody>
                                                <tr>
                                                    <th scope="row">
                                                        <div class="d-flex align-items-center">
                                                            <img src="<?php echo e(URL::asset('build/images/nft/img-01.jpg')); ?>"
                                                                alt=""
                                                ...
                                                <tr>
                                                    <th scope="row">
                                                        <div class="d-flex align-items-center">
                                                            <img src="<?php echo e(URL::asset('build/images/nft/img-03.jpg')); ?>"
                                                                alt=""
                                                                class="avatar-xs rounded object-fit-cover" />
                                                            <a href="apps-nft-item-details" class="text-body"><span
                                                ...
                                                <tr>
                                                    <th scope="row">
                                                        <div class="d-flex align-items-center">
                                                            <img src="<?php echo e(URL::asset('build/images/nft/img-06.jpg')); ?>"
                                                                alt=""
                                                                class="avatar-xs rounded object-fit-cover" />
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/rival/Documents/code/saas_gili/resources/views/apps-nft-item-details.blade.php ENDPATH**/ ?>