        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body d-flex flex-wrap gap-3 align-items-end">
                    <?php if(($isSuperAdminViewer ?? false) === true): ?>
                        <form method="GET" action="<?php echo e(url('/dashboard-analytics')); ?>" class="d-flex flex-wrap gap-2 align-items-end">
                            <div>
                                <label for="tenantScope" class="form-label mb-1">Tenant Scope</label>
                                <select id="tenantScope" name="tenant" class="form-select">
                                    <option value="">All Tenants</option>
                                    <?php $__currentLoopData = ($tenantOptions ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tenant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($tenant->code); ?>" <?php echo e(($selectedTenantCode ?? '') === (string) $tenant->code ? 'selected' : ''); ?>>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card card-animate">
                <div class="card-body">
                    ...
                    <h2 class="mt-3 ff-secondary fw-semibold"><?php echo e(number_format($summary['total_bookings'] ?? 0)); ?></h2>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6">
            <div class="card card-animate">
                <div class="card-body">
                    ...
                    <h2 class="mt-3 ff-secondary fw-semibold"><?php echo e(number_format($summary['upcoming_tours'] ?? 0)); ?></h2>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6">
            <div class="card card-animate">
                <div class="card-body">
                    ...
                    <h2 class="mt-3 ff-secondary fw-semibold"><?php echo e(number_format($summary['guests_expected'] ?? 0)); ?></h2>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6">
            <div class="card card-animate">
                <div class="card-body">
                    ...
                    <h2 class="mt-3 ff-secondary fw-semibold"><?php echo e(number_format($summary['needs_attention'] ?? 0)); ?></h2>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card card-animate">
                <div class="card-body">
                    ...
                    <h2 class="mt-3 ff-secondary fw-semibold"><?php echo e(number_format((float) ($summary['gross_sales'] ?? 0), 2)); ?></h2>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6">
            <div class="card card-animate">
                <div class="card-body">
                    ...
                    <h2 class="mt-3 ff-secondary fw-semibold"><?php echo e(number_format((float) ($summary['commission_total'] ?? 0), 2)); ?></h2>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6">
            <div class="card card-animate">
                <div class="card-body">
                    ...
                    <h2 class="mt-3 ff-secondary fw-semibold"><?php echo e(number_format((float) ($summary['net_revenue'] ?? 0), 2)); ?></h2>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6">
            <div class="card card-animate">
                <div class="card-body">
                    ...
                    <h2 class="mt-3 ff-secondary fw-semibold"><?php echo e(number_format((float) ($summary['revenue_idr'] ?? 0), 2)); ?></h2>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table align-middle table-nowrap mb-0">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = ($urgentBookings ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td><?php echo e($booking->tour_name); ?></td>
                                        <?php if(($isSuperAdminViewer ?? false) === true): ?>
                                            <td><?php echo e($booking->tenant?->name ?? '-'); ?></td>
                                        <?php endif; ?>
                                        ...
                                        <td><span class="badge bg-info-subtle text-info"><?php echo e($booking->status); ?></span></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <tr>
                                        <td colspan="<?php echo e(($isSuperAdminViewer ?? false) ? 5 : 4); ?>" class="text-muted">Tidak ada booking urgent dalam 24 jam.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table align-middle table-nowrap mb-0">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = ($recentBookings ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td><?php echo e($booking->tour_name); ?></td>
                                        <?php if(($isSuperAdminViewer ?? false) === true): ?>
                                            <td><?php echo e($booking->tenant?->name ?? '-'); ?></td>
                                        ...
                                        <td><span class="badge bg-primary-subtle text-primary"><?php echo e($booking->status); ?></span></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <tr>
                                        <td colspan="<?php echo e(($isSuperAdminViewer ?? false) ? 5 : 4); ?>" class="text-muted">Belum ada booking terbaru.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/rival/Documents/code/saas_gili/resources/views/dashboard-analytics.blade.php ENDPATH**/ ?>