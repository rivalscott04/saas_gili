            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        case ('id'): ?>
                        <img src="<?php echo e(URL::asset('build/images/flags/id.svg')); ?>" class="me-2 rounded" height="20" alt="Header Language">
                        <?php break; ?>
                        <?php default: ?>
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a href="<?php echo e(url('index/id')); ?>" class="dropdown-item notify-item language py-2" data-lang="id" title="Bahasa Indonesia">
...
<?php /**PATH /Users/rival/Documents/code/saas_gili/resources/views/layouts/topbar.blade.php ENDPATH**/ ?>