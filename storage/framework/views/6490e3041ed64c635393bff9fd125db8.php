<?php $__env->startSection('title'); ?>
    <?php echo e(__('translation.role-permissions')); ?>
            ...
            <div class="card">
                <div class="card-header border-0">
                    <div class="d-flex align-items-center">
                        <h5 class="card-title mb-0 flex-grow-1"><?php echo e(__('translation.dynamic-role-permissions')); ?></h5>
                        <div class="flex-shrink-0">
                            <span class="badge bg-primary-subtle text-primary"><?php echo e($tenant?->name ?? __('translation.tenant')); ?></span>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <div class="table-responsive table-card mt-2">
                            <table class="table align-middle table-nowrap mb-0">
                                <thead class="table-light text-muted text-uppercase">
                                    <tr>
                                        <th><?php echo e(__('translation.access')); ?></th>
                                        <th><?php echo e(__('translation.description')); ?></th>
                                        <th class="text-end"><?php echo e(__('translation.allow')); ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e(__('translation.permission-for-label', ['label' => strtolower($item['label'])])); ?></td>
                                            <td class="text-end">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            <button type="submit" class="btn btn-primary">
                                <i class="ri-save-line align-bottom me-1"></i> <?php echo e(__('translation.save-permissions')); ?>
    ...
    <script>
        (function() {
            var initRolePermissionAjax = function() {
                ...
                var baseUrl = "<?php echo e(route('tenant-role-permissions.index')); ?>";
                ...
                if (!roleSwitcher.dataset.ajaxBound) {
                    ...
                    roleSwitcher.addEventListener('change', function() {
                        var selectedTenant = tenantSwitcher ? tenantSwitcher.value : "<?php echo e($tenant?->code); ?>";
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/rival/Documents/code/saas_gili/resources/views/apps-tenant-role-permissions.blade.php ENDPATH**/ ?>