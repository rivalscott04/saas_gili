    ...
    <table class="table table-sm align-middle mb-0">
        ...
        <tbody>
                        ...
                        <?php else: ?>
                            <?php $__currentLoopData = $linkedTours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tourInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <a href="<?php echo e($tourUrl); ?>"
                                    ...
                                    title="Buka Tour Management untuk cek requirement lengkap">
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <tr>
                    <td colspan="7" class="text-muted">Belum ada data resource.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editResourceModalLabel<?php echo e($item->id); ?>">Edit Resource</h5>
                ...
                <div class="modal-body">
                    <form method="POST" action="<?php echo e(route('operations-resources.update', $item)); ?>">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-12">
                                <label class="form-label">Dipakai Tour</label>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php /**PATH /Users/rival/Documents/code/gilitour/resources/views/partials/operations-resource-list.blade.php ENDPATH**/ ?>