                    ...
                    <div class="col-sm-auto">
                        <div class="d-flex gap-1 flex-wrap">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', \App\Models\Booking::class)): ?>
                                <a href="<?php echo e(route('bookings.manual.create')); ?>" class="btn btn-soft-success"><i class="ri-add-line align-bottom me-1"></i> Create Booking</a>
                            <?php else: ?>
                            ...
                            <?php endif; ?>
                            <a href="<?php echo e(route('bookings.recap')); ?>" class="btn btn-primary"><i class="ri-bar-chart-box-line align-bottom me-1"></i> Revenue Recap</a>
                ...
                <ul class="nav nav-tabs nav-tabs-custom nav-success mb-3" role="tablist" id="bookingStatusTabs">
                    <li class="nav-item">
                        <a class="nav-link active py-3" href="#" data-status-filter="all">
                            ...
                            All
                            <span class="badge bg-secondary-subtle text-secondary align-middle ms-1"><?php echo e($statusCounts['all']); ?></span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link py-3" href="#" data-status-filter="reschedule_requested">
                            ...
                            Reschedule Request
                            <span class="badge bg-warning-subtle text-warning align-middle ms-1"><?php echo e($statusCounts['reschedule_requested']); ?></span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link py-3" href="#" data-status-filter="confirmed">
                            ...
                            Confirmed
                            <span class="badge bg-success-subtle text-success align-middle ms-1"><?php echo e($statusCounts['confirmed']); ?></span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link py-3" href="#" data-status-filter="on_tour">
                            ...
                            On Tour
                            <span class="badge bg-info-subtle text-info align-middle ms-1"><?php echo e($statusCounts['on_tour']); ?></span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link py-3" href="#" data-status-filter="standby">
                            ...
                            Standby
                            <span class="badge bg-secondary-subtle text-secondary align-middle ms-1"><?php echo e($statusCounts['standby']); ?></span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link py-3" href="#" data-status-filter="pending">
                            ...
                            Pending
                            <span class="badge bg-warning-subtle text-warning align-middle ms-1"><?php echo e($statusCounts['pending']); ?></span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link py-3" href="#" data-status-filter="cancelled">
                            ...
                            Cancelled
                            <span class="badge bg-danger-subtle text-danger align-middle ms-1"><?php echo e($statusCounts['cancelled']); ?></span>
                        </a>
                    </li>
                </ul>
                <div class="d-flex flex-wrap gap-2 mb-3" id="rescheduleWorkflowQuickChips">
                    <button type="button" class="btn btn-sm btn-soft-secondary active" data-workflow-chip="all">All workflow (<span data-workflow-chip-count><?php echo e($bookingRows->count()); ?></span>)</button>
                    <button type="button" class="btn btn-sm btn-soft-warning" data-workflow-chip="requested">Requested (<span data-workflow-chip-count><?php echo e($workflowCounts['requested']); ?></span>)</button>
                    <button type="button" class="btn btn-sm btn-soft-info" data-workflow-chip="reviewed">Reviewed (<span data-workflow-chip-count><?php echo e($workflowCounts['reviewed']); ?></span>)</button>
                    <button type="button" class="btn btn-sm btn-soft-primary" data-workflow-chip="approved">Approved (<span data-workflow-chip-count><?php echo e($workflowCounts['approved']); ?></span>)</button>
                    <button type="button" class="btn btn-sm btn-soft-danger" data-workflow-chip="rejected">Rejected (<span data-workflow-chip-count><?php echo e($workflowCounts['rejected']); ?></span>)</button>
                    <button type="button" class="btn btn-sm btn-soft-success" data-workflow-chip="completed">Completed (<span data-workflow-chip-count><?php echo e($workflowCounts['completed']); ?></span>)</button>
                    <button type="button" class="btn btn-sm btn-soft-dark" data-workflow-chip="no_request">No request (<span data-workflow-chip-count><?php echo e($workflowCounts['no_request']); ?></span>)</button>
                </div>
                    ...
                    <table class="table table-nowrap align-middle">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <tr
                                    data-booking-row
                                    data-tenant-id="<?php echo e($booking->tenant_id); ?>"
                                    data-status="<?php echo e(str_replace(' ', '_', strtolower((string) $booking->status))); ?>"
                                    data-response="<?php echo e(strtolower((string) $booking->customer_response)); ?>"
                                    data-reschedule-workflow="<?php echo e(strtolower((string) ($booking->latestReschedule?->workflow_status ?? ''))); ?>"
                                    data-search="<?php echo e(strtolower(($booking->customer?->full_name ?? $booking->customer_name ?? '').' '.($booking->tour_name ?? '').' '.($booking->guide_name ?? ''))); ?>"
                                    data-start-date="<?php echo e(optional($booking->tour_start_at)?->format('Y-m-d')); ?>"
                                >
                                    <td class="fw-medium" data-col-key="booking_id">#BK<?php echo e(str_pad((string) $booking->id, 5, '0', STR_PAD_LEFT)); ?></td>
                                    <td data-col-key="guest_name"><?php echo e($booking->customer?->full_name ?? $booking->customer_name ?? '-'); ?></td>
                                    <td data-col-key="tour_package"><?php echo e($booking->tour_name ?? '-'); ?></td>
                                    <td data-col-key="departure_date">
                                        <?php if($booking->tour_start_at): ?>
                                            <?php echo e($booking->tour_start_at->format('d M Y, H:i')); ?>

                                        <?php else: ?>
                                            -
                                        <?php endif; ?>
                                    </td>
                                    <td data-col-key="location"><?php echo e($booking->location ?? '-'); ?></td>
                                    <td data-col-key="guide"><?php echo e($booking->guide_name ?? '-'); ?></td>
                                    <td data-col-key="pax"><?php echo e($booking->participants ?? '-'); ?></td>
                                    <?php if(($canViewRevenue ?? false) === true): ?>
                                        <td data-col-key="channel"><?php echo e(strtoupper((string) ($booking->channel ?? '-'))); ?></td>
                                        <td data-col-key="net_revenue">
                                            ...
                                            <div class="fw-semibold">
                                                <?php echo e($originalCurrency); ?> <?php echo e(number_format($originalNet, 2)); ?>

                                            </div>
                                            <small class="text-muted d-block">
                                                Net IDR: IDR <?php echo e(number_format($idrNet, 0)); ?>

                                            </small>
                                        </td>
                                    <?php endif; ?>
                                    <td data-col-key="status">
                                        <span class="badge text-uppercase <?php echo e($statusClass); ?>"><?php echo e($statusLabel ?: 'Unknown'); ?></span>
                                        <?php if(!empty($bookingAllocationReadinessWarnings[$booking->id] ?? null)): ?>
                                            <div class="mt-1">
                                                <span class="badge bg-warning-subtle text-warning text-wrap text-start"
                                                    title="<?php echo e($bookingAllocationReadinessWarnings[$booking->id]); ?>">
                                                    <i class="ri-ship-line align-bottom me-1"></i>Resource
                                                </span>
                                            </div>
                                        <?php endif; ?>
                                    </td>
                                    <td data-col-key="assigned_guide"><?php echo e($booking->assigned_to_name ?? '-'); ?></td>
                                    <td data-col-key="attention">
                                        <?php if($booking->needs_attention): ?>
                                        ...
                                        <?php endif; ?>
                                        <?php if(($booking->reschedules_count ?? 0) > 0): ?>
                                            <div class="mt-1">
                                                <span class="badge bg-warning-subtle text-warning">
                                                    <i class="ri-calendar-event-line align-bottom me-1"></i>Reschedule x<?php echo e($booking->reschedules_count); ?>

                                                </span>
                                            </div>
                                            <?php if($booking->latestReschedule): ?>
                                                <small class="text-muted d-block mt-1">
                                                    Workflow:
                                                    <span class="fw-semibold text-capitalize"><?php echo e(str_replace('_', ' ', $booking->latestReschedule->workflow_status)); ?></span>
                                                </small>
                                            <?php endif; ?>
                                            <small class="text-muted d-block mt-1">
                                                Last request:
                                                <?php echo e($booking->reschedules_max_created_at ? \Illuminate\Support\Carbon::parse($booking->reschedules_max_created_at)->format('d M Y, H:i') : '-'); ?>
                                    ...
                                    <td>
                                        <button
                                            type="button"
                                            class="btn btn-sm <?php echo e(strtolower((string) $booking->status) === 'confirmed' ? 'btn-soft-secondary' : 'btn-soft-success'); ?> js-open-reminder-modal"
                                            data-bs-toggle="modal"
                                            data-bs-target="#bookingReminderModal"
                                            data-booking-id="<?php echo e($booking->id); ?>"
                                            data-booking-name="<?php echo e($booking->customer?->full_name ?? $booking->customer_name ?? '-'); ?>"
                                            data-booking-code="#BK<?php echo e(str_pad((string) $booking->id, 5, '0', STR_PAD_LEFT)); ?>"
                                            <?php echo e((strtolower((string) $booking->status) === 'confirmed' || !($canSendReminder ?? true)) ? 'disabled' : ''); ?>
                                        ...
                                        <button
                                            ...
                                            data-booking-name="<?php echo e($booking->customer?->full_name ?? $booking->customer_name ?? '-'); ?>"
                                            data-booking-code="#BK<?php echo e(str_pad((string) $booking->id, 5, '0', STR_PAD_LEFT)); ?>"
                                            data-booking-start="<?php echo e(optional($booking->tour_start_at)?->toIso8601String()); ?>"
                                            <?php echo e(!($canManageReschedule ?? true) ? 'disabled' : ''); ?>
                                        ...
                                        <?php if(auth()->user()?->isAdmin()): ?>
                                            <button
                                                ...
                                                data-booking-name="<?php echo e($booking->customer?->full_name ?? $booking->customer_name ?? '-'); ?>"
                                                data-booking-code="#BK<?php echo e(str_pad((string) $booking->id, 5, '0', STR_PAD_LEFT)); ?>"
                                                data-booking-date="<?php echo e(optional($booking->tour_start_at)?->toDateString()); ?>"
                                            >
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr>
                                    <td colspan="<?php echo e(($canViewRevenue ?? false) ? 13 : 11); ?>" class="text-center py-4 text-muted">
                ...
                <?php if($bookings->count() > 0): ?>
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mt-3">
                        <small class="text-muted">
                            Menampilkan <?php echo e($bookings->firstItem()); ?> - <?php echo e($bookings->lastItem()); ?> dari
                            <?php echo e($bookings->total()); ?> booking
                        </small>
                        ...
                        <div class="modal-content">
                            <form method="POST" id="bookingReminderForm">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <select class="form-select" name="template_id" required>
                                            <?php $__currentLoopData = $reminderTemplates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($template->id); ?>" <?php echo e((int) ($defaultReminderTemplateId ?? 0) === (int) $template->id ? 'selected' : ''); ?>>
                                                    <?php echo e($template->name); ?>

                                                </option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        <?php if($reminderTemplates->isEmpty()): ?>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-success" <?php echo e($reminderTemplates->isEmpty() ? 'disabled' : ''); ?>>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" name="tenant_resource_id" id="allocationResourceId" required>
                                                ...
                                                ?>
                                                <?php $__currentLoopData = $resourceGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resourceTenantId => $resourcesInTenant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($showResourceTenantOptgroups): ?>
                                                        <optgroup label="<?php echo e(optional($resourcesInTenant->first()->tenant)->name ?? 'Tenant #'.$resourceTenantId); ?>">
                                                            <?php $__currentLoopData = $resourcesInTenant; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resourceOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option
                                                                    value="<?php echo e($resourceOption->id); ?>"
                                                                    data-tenant-id="<?php echo e($resourceOption->tenant_id); ?>"
                                                                >
                                                                    <?php echo e($resourceOption->name); ?> (<?php echo e(strtoupper((string) $resourceOption->resource_type)); ?>)<?php echo e($resourceOption->reference_code ? ' - '.$resourceOption->reference_code : ''); ?>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        var reminderHistoryByBooking = <?php echo json_encode($reminderHistoryByBooking ?? [], 15, 512) ?>;
        var rescheduleHistoryByBooking = <?php echo json_encode($rescheduleHistoryByBooking ?? [], 15, 512) ?>;
        var bookingAllocationsByBooking = <?php echo json_encode($bookingAllocationsByBooking ?? [], 15, 512) ?>;
        var reminderTemplateSelect = reminderForm ? reminderForm.querySelector('select[name="template_id"]') : null;
        var defaultReminderTemplateId = '<?php echo e((string) ($defaultReminderTemplateId ?? '')); ?>';
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/rival/Documents/code/saas_gili/resources/views/apps-bookings.blade.php ENDPATH**/ ?>