        ...
        <div class="layout-wrapper landing">
                        ...
                        <div class="col-lg-8 col-sm-10">
                            <div class="text-center mt-lg-5 pt-5">
                                ...
                                <div class="d-flex gap-2 justify-content-center mt-4">
                                    <a href="<?php echo e(route('login', $popularPlanCode ? ['plan' => $popularPlanCode] : [])); ?>" class="btn btn-primary">Get Started <i
            ...
            <section class="section bg-light" id="plans">
                ...
                <div class="container">
                    ...
                    <div class="row gy-4">
                        <?php $__empty_1 = true; $__currentLoopData = $landingPricingPlans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="col-lg-4">
                                <div class="card plan-box mb-0 <?php echo e($plan->is_popular ? 'ribbon-box right' : ''); ?>">
                                    ...
                                    <div class="card-body p-4 m-2">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h5 class="mb-1 fw-bold"><?php echo e($plan->name); ?></h5>
                                                <p class="text-muted mb-0"><?php echo e($plan->subtitle); ?></p>
                                            </div>
                                            <div class="avatar-sm">
                                                <div class="avatar-title bg-light rounded-circle text-primary">
                                                    <i class="<?php echo e($plan->icon_class); ?> fs-20"></i>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="py-4 text-center">
                                            <h1 class="month"><sup><small>$</small></sup><span
                                                    class="ff-secondary fw-bold"><?php echo e($plan->price_monthly); ?></span> <span
                                                    class="fs-13 text-muted">/Month</span></h1>
                                            <h1 class="annual"><sup><small>$</small></sup><span
                                                    class="ff-secondary fw-bold"><?php echo e($plan->price_yearly); ?></span> <span
                                        ...
                                        <div>
                                            <ul class="list-unstyled text-muted vstack gap-3">
                                                <li>
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <?php echo $plan->maxUsersLineHtml(); ?>
                                                ...
                                                <?php $__currentLoopData = $plan->features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li>
                                                        <div class="d-flex">
                                                            <div
                                                                class="flex-shrink-0 <?php echo e($feature->is_included ? 'text-success' : 'text-danger'); ?> me-1">
                                                                <i
                                                                    class="<?php echo e($feature->is_included ? 'ri-checkbox-circle-fill' : 'ri-close-circle-fill'); ?> fs-15 align-middle"></i>
                                                            </div>
                                                            <div class="flex-grow-1">
                                                                <?php echo strip_tags($feature->display_text, '<b><strong>'); ?>
                                            ...
                                            <div class="mt-4">
                                                <a href="<?php echo e(route('login', ['plan' => $plan->code])); ?>" class="btn w-100"
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/rival/Documents/code/saas_gili/resources/views/landing.blade.php ENDPATH**/ ?>