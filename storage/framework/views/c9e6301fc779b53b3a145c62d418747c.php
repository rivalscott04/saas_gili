...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php $__env->slot('title'); ?>
            <?php echo e(__('translation.resource-management')); ?>
        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0"><?php echo e(__('translation.add-resource')); ?></h5>
                </div>
                <div class="card-body">
                    ...
                    <form method="POST" action="<?php echo e(route('operations-resources.store')); ?>" id="resourceCreateForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" min="1" name="capacity"
                                placeholder="<?php echo e(__('translation.optional')); ?>">
                        </div>
                        <div class="mb-3">
                            <label class="form-label"><?php echo e(__('translation.notes')); ?></label>
                            <textarea class="form-control" rows="3" name="notes"></textarea>
                        </div>
                        <button type="submit" class="btn btn-primary"><?php echo e(__('translation.save-resource')); ?></button>
                    </form>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-header border-0">
                    <div class="d-flex align-items-center gap-2 flex-wrap">
                        <h5 class="card-title mb-0 flex-grow-1"><?php echo e(__('translation.tenant-resource-list')); ?></h5>
                        <span class="badge bg-primary-subtle text-primary"><?php echo e($tenant->name); ?></span>
                        <?php if(auth()->user()?->isSuperAdmin()): ?>
                            <span class="badge bg-info-subtle text-info"><?php echo e(__('translation.superadmin-config-access')); ?></span>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="card-body">
                    <form method="GET" action="<?php echo e(route('operations-resources.index')); ?>" class="row g-2 mb-3"
                        ...
                        <div class="col-lg-3">
                            <select class="form-select" name="resource_type" id="resourceFilterType">
                                <option value=""><?php echo e(__('translation.all-types')); ?></option>
                                <?php $__currentLoopData = $resourceTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resourceTypeKey => $resourceTypeLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-lg-2">
                            <select class="form-select" name="required_by_active_tour" id="resourceFilterRequired">
                                <option value=""><?php echo e(__('translation.all-links')); ?></option>
                                <option value="1" <?php echo e(($filters['required_by_active_tour'] ?? '') === '1' ? 'selected' : ''); ?>>
                                    <?php echo e(__('translation.used-by-active-tour')); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/rival/Documents/code/saas_gili/resources/views/apps-operations-resources.blade.php ENDPATH**/ ?>